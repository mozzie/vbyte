...
has been widely adopted \citep[e.g.][]{Kon17}. 
...
method performs better. Additionally, due to how the data is stored, the proposed $select$ method offers fast access to the next or previous element. This makes a subarray fetch 
