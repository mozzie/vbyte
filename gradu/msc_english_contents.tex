...
Variable-byte encoding is a method for compressing integers of different byte length. An additional $continuous bit$ is added to the data to denote whether the compressed integer
