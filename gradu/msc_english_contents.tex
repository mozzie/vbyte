...
If an additional pointer array is stored during subarray decompression, only one $rank$ call for each accessed block level is needed. This can be observed from Figure~\ref{bris_ds}; the blocks of a subarray
...
Figures \ref{table:results8bit} and \ref{table:results4bit} show memory size requirements for $rank$ and $select$ data structures. The data sets consist of 50 million 64-bit numbers and 
the compressed size is a sum of continuation bit array and the data blocks.
...
coordinates {
(1,394.90)(2,654.60)(3,976.20)(4,1282.50)(5,1711.70)(6,2256.70)(7,2954.30)(8,3326.50)
};
\addplot[
color=red,
mark=ball,
...
coordinates {
(1,776.70)(2,1484.30)(3,2246.60)(4,2570.30)(5,3476.20)(6,4144.80)(7,4760.40)(8,6771.50)
};
\addplot[
color=green,
mark=triangle,
...
coordinates {
(1,393.70)(2,732.00)(3,1087.70)(4,1445.50)(5,1893.60)(6,2423.50)(7,3133.10)(8,3612.80)
};
\addplot[
color=black,
mark=diamond,
...
coordinates {
(1,804.10)(2,1711.80)(3,2640.60)(4,3080.70)(5,4126.30)(6,5022.10)(7,5788.50)(8,8258.20)
};
\addplot[
color=orange,
mark=square*,
...
coordinates {
(1,422.00)(2,508.40)(3,547.90)(4,636.30)(5,645.60)(6,664.50)(7,683.70)(8,703.30)
};
\addplot[
color=blue,
mark=star,
...
coordinates {
(1,569.40)(2,694.80)(3,676.80)(4,691.70)(5,708.30)(6,716.50)(7,780.10)(8,812.20)
};
\legend{bris8, bris4, bris8v5, bris4v5, select8, select4 }

TODO: create a dataset with low numbers and some large ones (every 40th or so)
