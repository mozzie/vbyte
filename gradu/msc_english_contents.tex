...
is assumed to perform better on data sets containing mostly small integers. It is assumed that larger numbers cause problems in performance. The performance of the proposed $select$ method is indifferent 
