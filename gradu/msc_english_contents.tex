...
these elements, $P$ is [2,1,0,-1]. The index locations of the fourth element are fetched from $P$ the same way. In the end $P$ is [3,2,0,-1] and the process could continue if needed.
...
\end{tikzpicture}
\caption{TODO this}\label{bris_subarray}

\end{figure}


 - TODO: does this need a picture?

 - TODO: is referring to Figure~\ref{bris_ds} enough or should this part have another image of the (maybe different) block setup

 - TODO: is the explanation unclear?
