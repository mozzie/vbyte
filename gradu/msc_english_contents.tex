...
An alternative solution with $select$ data structure is proposed and explained in detail later. Comparison to $rank$ by Brisaboa et al is shown with different
...
relative to the superblock. $Select$ 
